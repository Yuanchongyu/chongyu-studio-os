...
Never put the Supabase service-role key, OpenAI API key or Anthropic API key into browser JavaScript or GitHub.

## 5. pgvector is optional for V1
...
## 6. What you send me after setup
