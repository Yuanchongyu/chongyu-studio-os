...
function headers(extra={}){const k=key();if(!k)throw new Error('Supabase server key is not configured for this deployment.');const h={apikey:k,Authorization:`Bearer ${k}`,'Content-Type':'application/json',...extra};return h;}
